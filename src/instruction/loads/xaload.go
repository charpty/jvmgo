...
func (self *AALOAD) Execute(frame *runtimedata.Frame) {
...
func (self *BALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *CALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *DALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *FALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *IALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *LALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (self *SALOAD) Execute(frame *runtimedata.Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
